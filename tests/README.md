...
`scripts/check_beta_binomial_sbc_reference.py`,
`scripts/check_beta_regression_sbc_reference.py`, and
...
hierarchical count/proportion models have dedicated Stan posterior scripts for
Poisson, Binomial, Beta-binomial, Beta-regression, and Negative-binomial
hyperparameters.
